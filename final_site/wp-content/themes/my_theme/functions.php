...
function my_theme_scripts()
{
    ...
    wp_enqueue_script('counter', get_template_directory_uri() . '/node_modules/counterup/jquery.counterup.min.js', array('app-js'));
    wp_enqueue_script('main-js', get_template_directory_uri() . '/assets/js/main.min.js', array('counter', 'app-js'));
